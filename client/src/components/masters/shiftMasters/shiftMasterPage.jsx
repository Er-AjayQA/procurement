...
import { ShiftMasterListing } from "./shiftMasterListing";
import { useShiftMasterContext } from "../../../contextApis/useMastersContextFile";
import Select from "react-select";
import { ShiftMasterView } from "./shiftMasterView";
  ...
  return (
    <>
      <div className="px-5 h-full">
        ...
        {/* Shift View */}
        <ShiftMasterView onClose={() => handleViewVisibility("close")} />

        {/* Shift Form */}
        <ShiftMasterForm onClose={() => handleFormVisibility("close", "add")} />
      </div>
    </>
  );
};
