    ...
    <>
      <div className="shadow-lg rounded-md border border-gray-300 h-full flex flex-col">
        <div className="bg-button-hover py-2 px-2 rounded-t-md">
          <h3 className="text-white text-xs font-bold">UOM Listing</h3>
        </div>
              ...
              listing?.map((list, i) => {
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center p-2 text-[.8rem] overflow-hidden text-ellipsis whitespace-nowrap max-w-[200px]">
                      {list?.uom_description || "N/A"}
                    </div>
                    <div className="flex items-center p-2 text-[.8rem]">
                      {list.status ? (
