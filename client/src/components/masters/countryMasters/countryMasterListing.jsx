...
export const CountryMasterListing = () => {
  const {
    isLoading,
    listing,
    setViewId,
      ...
      <div className="shadow-lg rounded-md border border-gray-300 h-full flex flex-col">
        ...
        <div className="p-3 h-[86%]">
          <div className="grid grid-cols-6 border-b border-gray-300 gap-2">
            ...
            <div className="text-[.8rem] font-bold p-2">Nationality</div>
            <div className="text-[.8rem] font-bold p-2">Country Code</div>
            <div className="text-[.8rem] font-bold p-2">Phone Code</div>
              ...
              listing?.map((list, i) => {
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center p-2 text-[.8rem]">
                      {list?.nationality || "N/A"}
                    </div>
                    <div className="flex items-center p-2 text-[.8rem]">
                      {list?.country_code || "N/A"}
                    </div>
                    <div className="flex items-center p-2 text-[.8rem]">
                      {list?.phone_code || "N/A"}
                    </div>
