...
import { CountryMasterListing } from "./countryMasterListing";
import { CountryMasterView } from "./countryMasterView";
  ...
  return (
    <>
      <div className="px-5 h-full">
        ...
        <CountryMasterView onClose={() => handleViewVisibility("close")} />
      </div>
    </>
  );
};
