...
export const ServiceCategoryMasterView = ({ onClose }) => {
  const { viewVisibility, data } = useServiceCategoryMasterContext();
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <div>
                <span className="text-sm">
                  {data?.service_category_code || "N/A"}
                </span>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-2">
              ...
              <div>
                <span className="text-sm">
                  {data?.service_category_description || "N/A"}
                </span>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-2">
