...
export const ServiceCategoryMasterListing = () => {
  const {
    isLoading,
    listing,
      ...
      <div className="shadow-lg rounded-md border border-gray-300 h-full flex flex-col">
        ...
        <div className="p-3 h-[86%]">
          <div className="grid grid-cols-6 border-b border-gray-300 gap-2">
            ...
            <div className="text-[.8rem] font-bold p-2">Category Name</div>
            <div className="text-[.8rem] font-bold p-2">Category Code</div>
            <div className="text-[.8rem] font-bold p-2">Description</div>
              ...
              listing?.map((list, i) => {
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center p-2 text-[.8rem]">
                      {list?.service_category_code || "N/A"}
                    </div>
                    <div className="flex items-center p-2 text-[.8rem] overflow-hidden text-ellipsis whitespace-nowrap max-w-[150px]">
                      {list?.service_category_description || "N/A"}
                    </div>
                    <div className="flex items-center p-2 text-[.8rem]">
                      {list.status ? (
