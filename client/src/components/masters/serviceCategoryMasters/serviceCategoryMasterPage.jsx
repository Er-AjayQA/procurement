...
import { ServiceCategoryMasterListing } from "./serviceCategoryMasterListing";
import { ServiceCategoryMasterView } from "./serviceCategoryMasterView";
import { ServiceCategoryMasterForm } from "./serviceCategoryMasterForm";

export const ServiceCategoryMasterPage = () => {
  const {
    filter,
      ...
      <div className="px-5 h-full">
        <div className="flex justify-between items-center pt-3 pb-10">
          ...
          <div onClick={() => handleFormVisibility("open", "add")}>
            <AddButton text="Create Service Category" />
          </div>
        </div>

        {/* Service Category Listing */}
        <ServiceCategoryMasterListing />

        {/* Service Category ListViewing */}
        <ServiceCategoryMasterView
          onClose={() => handleViewVisibility("close")}
        />

        {/* Service Category Form */}
        <ServiceCategoryMasterForm
