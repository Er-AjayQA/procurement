...
export const EventCategoryMasterView = ({ onClose }) => {
  const { viewVisibility, data } = useEventCategoryMasterContext();
        ...
        <div className="w-[80%] mt-[10%] h-full mx-auto">
          <div className="h-[75%] overflow-y-scroll scrollbar-hide flex flex-col gap-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <div>
                <span className="text-sm">
                  {data?.event_category_description || "N/A"}
                </span>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-2">
