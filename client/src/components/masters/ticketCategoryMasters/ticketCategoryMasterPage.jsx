...
import { TicketCategoryMasterListing } from "./ticketCategoryMasterListing";
import { TicketCategoryMasterView } from "./ticketCategoryMasterView";
import { TicketCategoryMasterForm } from "./ticketCategoryMasterForm";

export const TicketCategoryMasterPage = () => {
  const {
    filter,
      ...
      <div className="px-5 h-full">
        <div className="flex justify-between items-center pt-3 pb-10">
          ...
          <div onClick={() => handleFormVisibility("open", "add")}>
            <AddButton text="Create Ticket Category" />
          </div>
        </div>

        {/* Ticket Category Listing */}
        <TicketCategoryMasterListing />

        {/* Ticket Category ListViewing */}
        <TicketCategoryMasterView
          onClose={() => handleViewVisibility("close")}
        />

        {/* Ticket Category Form */}
        <TicketCategoryMasterForm
