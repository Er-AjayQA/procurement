...
import { TransferTypeMasterListing } from "./transferTypeMasterListing";
import { TransferTypeMasterForm } from "./transferTypeMasterForm";
import { useTransferTypeMasterContext } from "../../../contextApis/useMastersContextFile";

export const TransferTypeMasterPage = () => {
  const {
    filter,
      ...
      <div className="px-5 h-full">
        <div className="flex justify-between items-center pt-3 pb-10">
          ...
          <div onClick={() => handleFormVisibility("open", "add")}>
            <AddButton text="Create Transfer Type" />
          </div>
        </div>

        {/* Transfer Type Listing */}
        <TransferTypeMasterListing />

        {/* Transfer Type Form */}
        <TransferTypeMasterForm
