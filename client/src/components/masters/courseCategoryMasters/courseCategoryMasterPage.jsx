...
import { CourseCategoryMasterListing } from "./courseCategoryMasterListing";
import { CourseCategoryMasterForm } from "./courseCategoryMasterForm";
import { useCourseCategoryMasterContext } from "../../../contextApis/useMastersContextFile";

export const CourseCategoryMasterPage = () => {
  const {
    filter,
      ...
      <div className="px-5 h-full">
        <div className="flex justify-between items-center pt-3 pb-10">
          ...
          <div onClick={() => handleFormVisibility("open", "add")}>
            <AddButton text="Create Course Category" />
          </div>
        </div>

        {/* Bank Listing */}
        <CourseCategoryMasterListing />

        {/* Bank Form */}
        <CourseCategoryMasterForm
