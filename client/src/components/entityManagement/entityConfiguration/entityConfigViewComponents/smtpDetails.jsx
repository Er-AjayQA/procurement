...
export const EntitySmtpDetails = () => {
          ...
          <div className="grid grid-cols-4 p-3 gap-3">
            <div className="flex flex-col gap-2 justify-center">
              ...
              <p className="text-[.7rem]">
                {data?.present_country_name || "N/A"}
              </p>
            </div>
            <div className="flex flex-col gap-2 justify-center">
              <label className="text-[.8rem]">State</label>
              <p className="text-[.7rem]">
                {data?.present_state_name || "N/A"}
              </p>
            </div>
            <div className="flex flex-col gap-2 justify-center">
              <label className="text-[.8rem]">City</label>
              <p className="text-[.7rem]">{data?.present_city_name || "N/A"}</p>
            </div>
            <div className="flex flex-col gap-2 justify-center">
              <label className="text-[.8rem]">Address</label>
              <p className="text-[.7rem]">{data?.present_address || "N/A"}</p>
            </div>
          </div>
        </div>
        ...
        <div className="shadow-lg rounded-md">
          ...
          <div className="grid grid-cols-4 p-3 gap-3">
            <div className="flex flex-col gap-2 justify-center">
              <label className="text-[.8rem]">Country</label>
              <p className="text-[.7rem]">
                {data?.permanent_country_name || "N/A"}
              </p>
            </div>
            <div className="flex flex-col gap-2 justify-center">
              <label className="text-[.8rem]">State</label>
              <p className="text-[.7rem]">
                {data?.permanent_state_name || "N/A"}
              </p>
            </div>
            <div className="flex flex-col gap-2 justify-center">
              <label className="text-[.8rem]">City</label>
              <p className="text-[.7rem]">
                {data?.permanent_city_name || "N/A"}
              </p>
            </div>
            <div className="flex flex-col gap-2 justify-center">
              <label className="text-[.8rem]">Address</label>
              <p className="text-[.7rem]">{data?.permanent_address || "N/A"}</p>
            </div>
          </div>
        </div>
        ...
        <div className="shadow-lg rounded-md">
          ...
          <div className="grid grid-cols-4 p-3 gap-3">
            <div className="flex flex-col gap-2 justify-center">
              ...
              <p className="text-[.7rem]">{data?.nationality || "N/A"}</p>
            </div>
            <div className="flex flex-col gap-2 justify-center">
              <label className="text-[.8rem]">State</label>
              <p className="text-[.7rem]">
                {data?.personal_state_name || "N/A"}
              </p>
            </div>
            <div className="flex flex-col gap-2 justify-center">
              <label className="text-[.8rem]">City</label>
              <p className="text-[.7rem]">
                {data?.personal_city_name || "N/A"}
              </p>
            </div>
            <div className="flex flex-col gap-2 justify-center">
              <label className="text-[.8rem]">ID Number</label>
              <p className="text-[.7rem]">{data?.id_number || "N/A"}</p>
            </div>
            <div className="flex flex-col gap-2 justify-center">
              <label className="text-[.8rem]">ID Issue Date</label>
              <p className="text-[.7rem]">{data?.id_issue_date || "N/A"}</p>
            </div>
            <div className="flex flex-col gap-2 justify-center">
              <label className="text-[.8rem]">ID Expiry Date</label>
              <p className="text-[.7rem]">{data?.id_exp_date || "N/A"}</p>
            </div>
            <div className="flex flex-col gap-2 justify-center">
              <label className="text-[.8rem]">DIRE Number</label>
              <p className="text-[.7rem]">{data?.dire_number || "N/A"}</p>
            </div>
            <div className="flex flex-col gap-2 justify-center">
              <label className="text-[.8rem]">Driving License No.</label>
              <p className="text-[.7rem]">{data?.driving_license || "N/A"}</p>
            </div>
            <div className="flex flex-col gap-2 justify-center">
              <label className="text-[.8rem]">Passport No.</label>
              <p className="text-[.7rem]">{data?.passport_number || "N/A"}</p>
            </div>
            <div className="flex flex-col gap-2 justify-center">
              <label className="text-[.8rem]">Passport Issue Date</label>
              <p className="text-[.7rem]">
                {data?.passport_issue_date || "N/A"}
              </p>
            </div>
            <div className="flex flex-col gap-2 justify-center">
              <label className="text-[.8rem]">Passport Expiry Date</label>
              <p className="text-[.7rem]">{data?.passport_exp_date || "N/A"}</p>
            </div>
            <div className="flex flex-col gap-2 justify-center">
              <label className="text-[.8rem]">Blood Group</label>
              <p className="text-[.7rem]">{data?.blood_group || "N/A"}</p>
            </div>
            <div className="flex flex-col gap-2 justify-center">
              <label className="text-[.8rem]">Tax number</label>
              <p className="text-[.7rem]">{data?.tax_number || "N/A"}</p>
            </div>
            <div className="flex flex-col gap-2 justify-center">
              <label className="text-[.8rem]">Marital Status</label>
              <p className="text-[.7rem]">{data?.marital_status || "N/A"}</p>
            </div>
            {data?.marital_status && (
              <div className="flex flex-col gap-2 justify-center">
                <label className="text-[.8rem]">Spouse Name</label>
                <p className="text-[.7rem]">{data?.spouse_name || "N/A"}</p>
              </div>
            )}
          </div>
        </div>
