...
export const EmployeeIdCardListing = () => {
  const {
    isLoading,
    listing,
    ...
    <>
      <div className="shadow-lg rounded-md border border-gray-300 h-full flex flex-col">
        <div className="bg-button-hover py-2 px-2 rounded-t-md">
          <h3 className="text-white text-xs font-bold">Employees Listing</h3>
        </div>
        ...
        <div className="p-3 h-[86%]">
          <div className="grid grid-cols-7 border-b border-gray-300 gap-2">
            ...
            <div className="text-[.8rem] font-bold p-2">Emp Code</div>
            <div className="text-[.8rem] font-bold p-2">Branch</div>
            <div className="text-[.8rem] font-bold p-2">Designation</div>
              ...
              listing?.map((list, i) => {
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center p-2 text-[.8rem]">
                      {list.branch_name || "N/A"}
                    </div>
                    <div className="flex items-center p-2 text-[.8rem]">
                      {list.designation_name || "N/A"}
                    </div>
                    <div className="flex items-center p-2 text-[.8rem]">
                      {list.isIDgenerated ? (
