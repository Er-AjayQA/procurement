...
export const createTransfer = async (selectedEntity, formData) => {
...
export const updateTransfer = async (selectedEntity, id, formData) => {
  try {
...
export const getAllTransfer = async (selectedEntity, id, formData) => {
  const response = await axiosInstance.post(
...
export const getAllTransfersApprovalPendingByUser = async (
  selectedEntity,
  id,
  formData
) => {
...
export const getAllTransfersApprovedByUser = async (
  selectedEntity,
  id,
  formData
) => {
...
export const getAllTransfersRejectedByUser = async (
  selectedEntity,
  id,
  formData
) => {
...
export const approvalForTransfer = async (selectedEntity, id, formData) => {
  const response = await axiosInstance.post(
